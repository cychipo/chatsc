...
Tài liệu này mô tả các giao diện bên ngoài và ranh giới tích hợp của hệ thống chat Socket với Docker và Kernel Module ở mức hành vi, phục vụ thiết kế và kiểm thử.
...
### Contract
- Hệ thống phải cung cấp một môi trường phát triển chuẩn trong container Ubuntu.
- Môi trường này phải cho phép build các thành phần user-space của hệ thống mà không yêu cầu cài thêm công cụ trên host.
- Source code phải sẵn sàng để developer chỉnh sửa và build trong container.

### Observable Outcomes
- Developer có thể khởi động môi trường phát triển.
...
### Contract
- Client và server phải thiết lập được phiên chat qua socket trong mạng container.
