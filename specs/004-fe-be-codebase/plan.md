...
**Branch**: `004-chat-groups` | **Date**: 2026-04-04 | **Spec**: [spec.md](./spec.md)
...
3. Dựng frontend React/Vite skeleton với Ant Design, Zustand, Axios layer, Lucide và theme glassstyle toàn cục.
...
6. Thiết lập test entrypoints riêng cho frontend và backend để developer chạy đúng nhóm kiểm tra theo phạm vi thay đổi.
